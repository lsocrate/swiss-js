...
test("Get match matrix", function () {
  ...
  equal(matrix.matrix.size(), 9)
  ok(matrix.matrix["mp1@p3"])
  ok(matrix.matrix["mp1@p4"])
  ok(matrix.matrix["mp1@p5"])
  ok(matrix.matrix["mp2@p3"])
  ok(matrix.matrix["mp2@p4"])
  ok(matrix.matrix["mp2@p5"])
  ok(matrix.matrix["mp3@p4"])
  ok(matrix.matrix["mp3@p5"])
  ok(matrix.matrix["mp4@p5"])
})